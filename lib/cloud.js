...
module.exports = function Cloud(opts){
	...
	var opts = opts || {};
	var ignoredWords  = opts.ignoredWords || ["no","si","sin","se","son","hay","al","te","que","es","por","para","las","los","de", "en", "le","la","lo","del","con","ese","esa", "el", "una", "un","zak","facu","facundo","mendez","zack","mendes","fac","faku","unos","uno","a","que","me","y","?"];
	...
	var minFontSize = opts.minFontSize || 25;
	var maxFontSize = opts.maxFontSize || 120;
	var requireMinWords = opts.requireMinWords || 50;
